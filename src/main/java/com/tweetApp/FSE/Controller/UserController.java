...
import com.tweetApp.FSE.cofig.Consumer;
import com.tweetApp.FSE.cofig.ProducerService;
...
public class UserController {
	...
	public ResponseEntity<RegisterDTO> register(@RequestBody RegisterDTO registerDTO) {
		...
		this.producerService.sendMessage( registerDTO.getEmail());                        //added
	...
	public ResponseEntity<LoginResponseDTO> signUp(@RequestBody LoginRequestDTO loginRequest) {
		...
		this.producerService.sendMessage( loginRequest.getEmail());                   //added
